...
import (
	...
	"github.com/OpenCHAMI/node-service/pkg/client"
...
Examples:
  # Create from stdin
  echo '{"xname": "example-name", "role": "example-value", "subRole": "example-value", "architecture": "example-value", "bmcAddress": "192.168.1.1", "macAddress": "192.168.1.1", "labels": {"{"key":"value"}": "value"}}' | client node create

  # Create with --spec flag
  client node create --spec '{"xname": "example-name", "role": "example-value", "subRole": "example-value", "architecture": "example-value", "bmcAddress": "192.168.1.1", "macAddress": "192.168.1.1", "labels": {"{"key":"value"}": "value"}}'
...
Examples:
  # Update from stdin
  echo '{"xname": "example-name", "role": "example-value", "subRole": "example-value", "architecture": "example-value", "bmcAddress": "192.168.1.1", "macAddress": "192.168.1.1", "labels": {"{"key":"value"}": "value"}}' | client node update <uid>

  # Update with --spec flag
  client node update <uid> --spec '{"xname": "example-name", "role": "example-value", "subRole": "example-value", "architecture": "example-value", "bmcAddress": "192.168.1.1", "macAddress": "192.168.1.1", "labels": {"{"key":"value"}": "value"}}'
...
Examples:
  # Create from stdin
  echo '{"xnames": ["["item1","item2"]"], "labels": {"{"key":"value"}": "value"}, "xNamePattern": "example-name"}' | client nodeset create

  # Create with --spec flag
  client nodeset create --spec '{"xnames": ["["item1","item2"]"], "labels": {"{"key":"value"}": "value"}, "xNamePattern": "example-name"}'
...
Examples:
  # Update from stdin
  echo '{"xnames": ["["item1","item2"]"], "labels": {"{"key":"value"}": "value"}, "xNamePattern": "example-name"}' | client nodeset update <uid>

  # Update with --spec flag
  client nodeset update <uid> --spec '{"xnames": ["["item1","item2"]"], "labels": {"{"key":"value"}": "value"}, "xNamePattern": "example-name"}'
