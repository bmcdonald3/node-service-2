...
// Generated: 2026-02-03T14:30:10-08:00
//
...
//  1. Create v2beta1 package: pkg/resources/nodeset/v2beta1/
...
func CreateNodeSet(w http.ResponseWriter, r *http.Request) {
	...
	nodeSet := &nodeset.NodeSet{
		...
		Spec: req.NodeSetSpec,
	}

	nodeSet.Metadata.Initialize(req.Name, uid)

	// Set labels and annotations
	for k, v := range req.Labels {
		nodeSet.SetLabel(k, v)
	}
	for k, v := range req.Annotations {
		nodeSet.SetAnnotation(k, v)
	}

	// Layer 2: Fabrica struct tag validation
	if err := validation.ValidateResource(nodeSet); err != nil {
	...
	if err := events.PublishResourceCreated(r.Context(), "NodeSet", nodeSet.GetUID(), nodeSet.GetName(), nodeSet); err != nil {
...
func UpdateNodeSet(w http.ResponseWriter, r *http.Request) {
	...
	if err := events.PublishResourceUpdated(r.Context(), "NodeSet", nodeSet.GetUID(), nodeSet.GetName(), nodeSet, updateMetadata); err != nil {
		// Log the error but don't fail the request - events are non-critical
...
func PatchNodeSet(w http.ResponseWriter, r *http.Request) {
	...
	if err := events.PublishResourcePatched(r.Context(), "NodeSet", nodeSet.GetUID(), nodeSet.GetName(), nodeSet, patchMetadata); err != nil {
		// Log the error but don't fail the request - events are non-critical
...
func UpdateNodeSetStatus(w http.ResponseWriter, r *http.Request) {
	...
	var statusUpdate nodeset.NodeSetStatus
	...
	if err := events.PublishResourceUpdated(r.Context(), "NodeSet", res.GetUID(), res.GetName(), res, statusMetadata); err != nil {
...
func PatchNodeSetStatus(w http.ResponseWriter, r *http.Request) {
	...
	if err := events.PublishResourcePatched(r.Context(), "NodeSet", res.GetUID(), res.GetName(), res, patchMetadata); err != nil {
...
func DeleteNodeSet(w http.ResponseWriter, r *http.Request) {
	...
	if err := events.PublishResourceDeleted(r.Context(), "NodeSet", nodeSet.GetUID(), nodeSet.GetName(), deleteMetadata); err != nil {
		// Log the error but don't fail the request - events are non-critical
