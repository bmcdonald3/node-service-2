...
//
// Returns:
//   - []*nodeset.NodeSet: Slice of NodeSet resources
//   - error: Any error that occurred during loading
func LoadAllNodeSets(ctx context.Context) ([]*nodeset.NodeSet, error) {
	ensureBackend()
	...
	nodesets := make([]*nodeset.NodeSet, 0, len(rawData))
	for _, raw := range rawData {
...
//
// Returns:
//   - *nodeset.NodeSet: The NodeSet resource
//   - error: fabricaStorage.ErrNotFound if resource doesn't exist, other errors for failures
func LoadNodeSet(ctx context.Context, uid string) (*nodeset.NodeSet, error) {
	ensureBackend()
...
// Returns:
//   - error: Any error that occurred during saving
func SaveNodeSet(ctx context.Context, nodeSet *nodeset.NodeSet) error {
	ensureBackend()
...
// Returns:
//   - error: fabricaStorage.ErrNotFound if resource doesn't exist, other errors for failures
func UpdateNodeSet(ctx context.Context, nodeSet *nodeset.NodeSet) error {
	ensureBackend()
